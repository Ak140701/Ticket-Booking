...
import com.aks.tickets.domain.dtos.ErrorDto;
import com.aks.tickets.exceptions.*;
...
public class GlobalExceptionHandler  {
    ...
    public ResponseEntity<ErrorDto> handleUserNotFoundException(EventNotFoundException ex) {
